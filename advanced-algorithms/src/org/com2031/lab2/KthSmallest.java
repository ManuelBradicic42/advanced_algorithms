...
public class KthSmallest {
	...
	public static Integer dac_kthSmallest(int k, ArrayList<Integer> arr){
		...
		if (arr.size() == 0) {
			...
			//System.out.println("k: " + k + "pivot: " + pivot + " leftarr" + leftarr.toString() + "rightarr" + rightarr.toString());
	...
	public static void testKthSmallest(String name, int k, ArrayList<Integer> test, int expected){
	    ...
	    if (ans==expected){
	    	System.out.println("  Pass:   "+name + " Expected: " + expected + " Ans: " + ans);
	    }
	    else {
	    	System.out.println("*********************");	    	
	    	System.out.println("  Fail:   "+name + " Expected: " + expected+ " Ans: " + ans);
	    	System.out.println("*********************");
	    }
	}
